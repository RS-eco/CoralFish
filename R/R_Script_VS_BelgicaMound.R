...
#Plot CFW per Area
summaryCFW <- summarySE(subbelgica, measurevar="X.CFW", groupvars="Habitat")
...
summarySpeciesFA <- summarySE(subbelgica, measurevar="AllSpeciesFA", groupvars="Habitat")
...
summarySpeciesFB <- summarySE(subbelgica, measurevar="AllSpeciesFB", groupvars="Habitat")
