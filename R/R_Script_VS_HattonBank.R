...
#Plot CFW per Area
summaryCFW <- summarySE(subhatton, measurevar="X.CFW", groupvars="Habitat")
...
summarySpeciesFA <- summarySE(subhatton, measurevar="AllSpeciesFA", groupvars="Habitat")
...
summarySpeciesFB <- summarySE(subhatton, measurevar="AllSpeciesFB", groupvars="Habitat")
